...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Okt 2021 pada 17.37
...
-- Prosedur
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_dashboard_chartpenduduk` ()  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_permohonan_surat` (IN `aksi` VARCHAR(255), IN `param_id_surat_permohonan` INT(11), IN `param_nama` VARCHAR(100), IN `param_ttl` VARCHAR(100), IN `param_kewarganegaraan` VARCHAR(45), IN `param_agama` VARCHAR(45), IN `param_pekerjaan` VARCHAR(45), IN `param_alamat` VARCHAR(255), IN `param_nik` VARCHAR(45), IN `param_keperluan` VARCHAR(255), IN `param_keterangan` VARCHAR(255), IN `param_nomer` INT(11), IN `param_bulan` VARCHAR(20), IN `param_tahun` VARCHAR(10), IN `param_file_upload` VARCHAR(255))  BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_permohonan_surat_old` (IN `aksi` VARCHAR(255), IN `param_id_surat_permohonan` INT(11), IN `param_nama` VARCHAR(100), IN `param_ttl` VARCHAR(100), IN `param_kewarganegaraan` VARCHAR(45), IN `param_agama` VARCHAR(45), IN `param_pekerjaan` VARCHAR(45), IN `param_alamat` VARCHAR(255), IN `param_nik` VARCHAR(45), IN `param_keperluan` VARCHAR(255), IN `param_keterangan` VARCHAR(255), IN `param_nomer` INT(11), IN `param_bulan` VARCHAR(20), IN `param_tahun` VARCHAR(10), IN `param_file_upload` VARCHAR(255))  BEGIN
...
INSERT INTO `admin` (`id`, `nama`, `email`, `password`, `verify_at`) VALUES
(2, 'dina', 'lusianadina114@gmail.com', '$2y$10$ssV6WS7sZ5cU0TbSElRAfu54yKxXodX0Yz2J9soGcLRtCtCg0hHgS', '2021-10-05 10:23:43'),
(3, 'admin', 'dinalusiana275@gmail.com', '$2y$10$3arpkkn4A/FtaCzxNlqX5u0YEdSqZK5/X8ITiFuyyL/u6Cz3byWna', '2021-10-06 22:55:35');
...
INSERT INTO `agama` (`id_agama`, `agama`, `deleted_at`) VALUES
(1, 'islam', NULL),
(2, 'kristen', NULL),
(3, 'budha', NULL),
(4, 'Hindu', '2021-10-03 09:09:56'),
(6, 'Hindu', NULL);
...
INSERT INTO `artikel` (`id`, `title`, `content`, `image`, `url`, `date_created`) VALUES
(10, 'Karnaval Desa Sejomulyo', '<p>Karnaval Desa Sejomulyo tahun 2019 dilaksanakan pada hari minggu tanggal 1 April 2021</p><p><br></p>', 'karnaval1.png', 'Karnaval-Desa-Sejomulyo_ID10', 1633244036);
...
INSERT INTO `bansos` (`id_bansos`, `jenis_bantuan`, `deleted_at`) VALUES
(1, 'a', '2021-10-01 14:54:08');
...
(1, 'a', 'SE__22_Tahun_2021_ttg_Penyelenggaraan_Uji_Coba_PTM.pdf');
...
INSERT INTO `dusun` (`id_dusun`, `dusun`, `deleted_at`) VALUES
(1, 'Garuwan', '2021-09-30 22:53:31'),
(3, 'Gadungan', '2021-10-05 10:13:37'),
(4, 'Babatan', NULL),
(5, 'Gadungan', NULL);
...
INSERT INTO `foto` (`id`, `title`, `content`, `image`, `date_created`) VALUES
(5, 'tes', '<p>aa</p>', '2.jpg', 1633244756);
...
--
-- Dumping data untuk tabel `halaman_web`
--

INSERT INTO `halaman_web` (`id`, `slug`, `judul_halaman`, `isi_halaman`, `level`) VALUES
...
INSERT INTO `jabatan` (`id_jabatan`, `jabatan`, `deleted_at`) VALUES
(1, 'a', '2021-10-01 14:55:43'),
(2, 'Kepala Desa', NULL),
(3, 'Sekretaris', NULL),
(4, 'bendahara1', NULL);
...
INSERT INTO `pekerjaan` (`id_pekerjaan`, `jenis_pekerjaan`, `deleted_at`) VALUES
(2, 'Wiraswasta', NULL),
(4, 'Pelajar', '2021-10-05 10:59:16'),
(5, 'Pelajar', NULL);
...
INSERT INTO `pendidikan` (`id_pendidikan`, `tingkat_pendidikan`, `deleted_at`) VALUES
(1, 'Tidak Lulus SD', '2021-10-03 08:44:00'),
(2, 'SMP', '2021-10-02 21:04:34'),
(3, 'SMA', NULL),
(5, 'SMP', NULL),
(6, 'tdk SD', '2021-10-03 09:08:08'),
(7, 'Tidak Lulus SD', NULL);
...
INSERT INTO `penduduk` (`id`, `nik`, `nama`, `gender`, `usia`, `id_rt`, `id_dusun`, `id_pendidikan`, `id_pekerjaan`, `id_agama`, `deleted_at`, `ttl`, `alamat`) VALUES
(5, '1', 'dina', 'Pria', 31, 1, 4, 2, 2, 1, '2021-10-03 08:40:19', 'Pati ', 'sejomulyo'),
(6, '1', 'dina', 'Pria', 5, 4, 4, 7, 2, 6, NULL, 'Pati', 'sejomulyo'),
(7, '2', 'dikin', 'Pria', 23, 2, 5, 3, 2, 1, NULL, 'Pati, 1 Januari 2021', 'Garuwan 12'),
(8, '3', 'aku', 'Pria', 31, 1, 5, 3, 5, 1, NULL, 'Pati', 'sejomulyo');
...
INSERT INTO `permohonan_surat` (`id_surat_permohonan`, `nama`, `ttl`, `kewarganegaraan`, `agama`, `pekerjaan`, `alamat`, `nik`, `keperluan`, `keterangan`, `nomer`, `bulan`, `tahun`, `file_upload`) VALUES
(6, 'dina', 'Pati', 'Indonesia', 'Hindu', 'Wiraswasta', 'sejomulyo', '1', 'keterangan', 'aaa', 1, 'X', '2021', NULL),
(7, 'aku', 'Pati', 'Indonesia', 'islam', 'Pelajar', 'sejomulyo', '3', 'keterangan', 'izin', 2, 'X', '2021', NULL),
(8, 'dina', 'Pati', 'Indonesia', 'Hindu', 'Wiraswasta', 'sejomulyo', '1', 'keterangan', 'apa ', 3, 'X', '2021', NULL);
...
INSERT INTO `rt` (`id_rt`, `rt`, `deleted_at`) VALUES
(1, '1', NULL),
(2, '2', NULL),
(3, '3', NULL),
(4, '4', NULL),
...
INSERT INTO `surat` (`nomor`, `nama_kades`, `jabatan_kades`, `alamat_kades`, `nama_pemohon`, `ttl_pemohon`, `kewarganegaraan_pemohon`, `agama_pemohon`, `pekerjaan_pemohon`, `alamat_pemohon`, `nik_pemohon`, `keperluan`, `berlaku`, `keterangan`, `id_permohonan_surat`) VALUES
('0001/4/X/2021', 'Hardi', 'Sekretaris Desa', 'Desa Sejomulyo', 'dina', 'Pati', 'Indonesia', 'Hindu', 'Wiraswasta', 'sejomulyo', 1, 'keterangan', '2021-10-05', 'aaa', 6),
('0002/5/X/2021', 'Hardi', 'kades', 'juwana', 'aku', 'Pati', 'Indonesia', 'islam', 'Pelajar', 'sejomulyo', 3, 'keterangan', '2000-12-02', 'izin', 7);
...
--
-- Indeks untuk tabel `halaman_web`
--
ALTER TABLE `halaman_web`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `bansos`
  MODIFY `id_bansos` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `dusun`
  MODIFY `id_dusun` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT untuk tabel `halaman_web`
--
ALTER TABLE `halaman_web`
  MODIFY `id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `pemerintah_desa`
  MODIFY `id_pemdes` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `permohonan_surat`
  MODIFY `id_surat_permohonan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `rt`
  MODIFY `id_rt` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- Ketidakleluasaan untuk tabel `bantuan_sosial`
--
ALTER TABLE `bantuan_sosial`
  ADD CONSTRAINT `bantuan_sosial_ibfk_1` FOREIGN KEY (`id`) REFERENCES `penduduk` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `bantuan_sosial_ibfk_2` FOREIGN KEY (`id_bansos`) REFERENCES `bansos` (`id_bansos`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `pemerintah_desa`
--
ALTER TABLE `pemerintah_desa`
  ADD CONSTRAINT `pemerintah_desa_ibfk_1` FOREIGN KEY (`id`) REFERENCES `penduduk` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pemerintah_desa_ibfk_2` FOREIGN KEY (`id_jabatan`) REFERENCES `jabatan` (`id_jabatan`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `penduduk`
  ...
  ADD CONSTRAINT `penduduk_ibfk_3` FOREIGN KEY (`id_pendidikan`) REFERENCES `pendidikan` (`id_pendidikan`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `penduduk_ibfk_4` FOREIGN KEY (`id_rt`) REFERENCES `rt` (`id_rt`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `penduduk_ibfk_5` FOREIGN KEY (`id_dusun`) REFERENCES `dusun` (`id_dusun`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
