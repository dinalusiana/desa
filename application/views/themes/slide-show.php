...
<section id="featured">
    ...
    <div class="camera_wrap" id="camera-slide">
        <?php foreach ($news as $row) : ?>
            <div data-src="<?php echo base_url('public/'); ?>img/slides/camera/slide1/tes.png">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="span6">
                                ...
                                <a href="<?php echo base_url(); ?>artikel/readmore/<?php echo $row['id']; ?>" class="btn btn-success btn- animated fadeInUp">
