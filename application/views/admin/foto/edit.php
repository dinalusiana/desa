...
<div id="content">
    ...
    <div class="content-inner">
        <div class="form-wrapper">
            <?php echo form_open_multipart('admin/foto/edit', array('method' => 'POST')); ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <img src="<?= base_url('upload_file/images/' . $foto['image']); ?>" class="img-thumbnail" style="width:100px; height:80px;">
                </div>
                <input class="form-control-file <?php echo form_error('image') ? 'is-invalid' : '' ?>" type="file" name="image" />
                <input type="hidden" name="old_image" value="<?php echo $foto['image']; ?>" />
            ...
            <div class="form-group">
                ...
                <textarea class="form-control summernote" name="content"><?= $foto['content']; ?></textarea>
