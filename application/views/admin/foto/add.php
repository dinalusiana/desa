...
<div id="content">
    <header>
        <h2 class="page_title">Tambah Foto</h2>
    </header>

    <div class="content-inner">
        <div class="form-wrapper">
            <?php echo form_open_multipart('admin/foto/tambah', array('method' => 'POST')); ?>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control summernote" placeholder="foto..." name="content"></textarea>
