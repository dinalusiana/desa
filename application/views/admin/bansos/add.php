...
<div id="content">
    <header>
        <h2 class="page_title">Tambah bansos</h2>
    </header>

    <div class="content-inner">
        <div class="form-wrapper">
            <form action="<?= base_url('admin/bansos/tambah'); ?>" class="form-horizontal" method="post">
            
                <div class="form-group">
                    <label for="title" class="col-sm-2 control-label">Jenis Bantuan</label>
                    <div class="col-sm-8">
                        <input type="text" name="jenis_bantuan" class="form-control" id="jenis_bantuan" placeholder="Jenis Bantuan ..." value="<?= set_value('nama_bansos'); ?>">
