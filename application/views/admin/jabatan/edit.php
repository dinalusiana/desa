...
<div id="content">
    <header>
        <h2 class="page_title">Update jabatan</h2>
    </header>

    <div class="content-inner">
        <div class="form-wrapper">
            <form action="<?= base_url('admin/jabatan/edit'); ?>" class="form-horizontal" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="jabatan" class="form-control" id="jabatan" value="<?= $jabatan['jabatan']; ?>">
                    </div>
                </div>
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="jumlah" class="form-control" id="jumlah" value="<?= $jabatan['jumlah']; ?>">
                    </div>
                </div> -->
