...
<div id="content">
    <header>
        <h2 class="page_title">Update Agama</h2>
    </header>

    <div class="content-inner">
        <div class="form-wrapper">
            <form action="<?= base_url('admin/agama/edit'); ?>" class="form-horizontal" method="post">
                <input type="hidden" name="id_agama" value="<?= $agama['id_agama']; ?>">

                <div class="form-group">
                    <label for="title" class="col-sm-2 control-label">Agama</label>
                    <div class="col-sm-8">
                        <input type="text" name="agama" class="form-control" id="agama" value="<?= $agama['agama']; ?>">
                    </div>
                </div>
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="jumlah" class="form-control" id="jumlah" value="<?= $agama['jumlah']; ?>">
                    </div>
                </div> -->
