...
<div id="content">
    <header>
        <h2 class="page_title">Tambah dusun</h2>
    </header>

    <div class="content-inner">
        <div class="form-wrapper">
            <form action="<?= base_url('admin/dusun/tambah'); ?>" class="form-horizontal" method="post">
            
                <div class="form-group">
                    <label for="title" class="col-sm-2 control-label">Dusun</label>
                    <div class="col-sm-8">
                        <input type="text" name="dusun" class="form-control" id="dusun" placeholder="Dusun ..." value="<?= set_value('dusun'); ?>">
