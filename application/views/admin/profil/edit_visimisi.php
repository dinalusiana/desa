...
<div id="content">
    <header>
        <h2 class="page_title">Update Visi Misi</h2>
    </header>
    ...
    <div class="content-inner">
        <div class="form-wrapper">
            ...
            <div class="form-group">
                <label for="title">visi misi Desa</label>
                <textarea class="form-control summernote" placeholder="visi misi Desa" name="profil"><?= $visimisi['profil']; ?></textarea>
