...
<div id="content">
    <header>
        <h2 class="page_title">Tambah balita</h2>
    </header>

    <div class="content-inner">
        <div class="form-wrapper">
            <form action="<?= base_url('admin/balita/tambah'); ?>" class="form-horizontal" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="panjang" class="form-control" id="panjang" placeholder="panjang .." value="<?= set_value('panjang'); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="berat" class="form-control" id="berat" placeholder="Berat..." value="<?= set_value('berat'); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text" name="nama_ibu" class="form-control" id="nama_ibu" placeholder="nama_ibu..." value="<?= set_value('nama_ibu'); ?>">
